    ...
    if entry_ch in "":
        ...
        if entry_ch in "":
            if entry_cL == entry_cR:
                ...
                entry_ch=""
        if entry_ch in "":
            entry_t=entry_t[:entry_cL]+entry_t[entry_cR+1:]
        if entry_ch in "":
...
LTsv_kbdentry_text_LCR,LTsv_kbdentry_text_XL,LTsv_kbdentry_text_LX,LTsv_kbdentry_text_SEL,LTsv_kbdentry_text_WK={},{},{},{},{}
def LTsv_kbdentry_new(LTsv_windowPAGENAME,widget_n=None,event_b=None,clip_c=None,clip_v=None,clip_e=None,widget_x=0,widget_y=0,widget_w=LTsv_glyph_kbdW,widget_h=LTsv_glyph_kbdH,event_w=50):
    ...
    def kbdentry_input(kbdentry):
        global LTsv_kbdentry_text_LCR,LTsv_kbdentry_text_XL,LTsv_kbdentry_text_LX,LTsv_kbdentry_text_SEL,LTsv_kbdentry_text_WK
        ...
        LTsv_draw_delete()
        LTsv_draw_color(LTsv_kbdentry_fontcolor[kbdentry_canvas])
        LTsv_kbdentry_text_XL[kbdentry_canvas]=LTsv_draw_glyphsentry(draw_t=LTsv_kbdentry_text[kbdentry_canvas],draw_x=LTsv_kbdentry_text_LX[kbdentry_canvas],draw_y=LTsv_kbdentry_y[kbdentry_canvas],draw_cL=LTsv_kbdentry_cursorL[kbdentry_canvas],draw_cR=LTsv_kbdentry_cursorR[kbdentry_canvas],draw_f=LTsv_glyph_kbdH//2,draw_g="漫")
    ...
    def kbdentry_press(window_objvoid=None,window_objptr=None):
        ...
        global LTsv_kbdentry_text_LCR,LTsv_kbdentry_text_XL,LTsv_kbdentry_text_LX,LTsv_kbdentry_text_SEL,LTsv_kbdentry_text_WK
        LTsv_draw_selcanvas(kbdentry_canvas)
        if LTsv_glyph_mousepress(kbdentry_canvas,LTsv_kbdentry_x[kbdentry_canvas],LTsv_kbdentry_y[kbdentry_canvas]) == LTsv_glyph_None:
            motionX=LTsv_global_canvasmotionX()
            for xl in range(len(LTsv_kbdentry_text_XL[kbdentry_canvas])-1):
                if LTsv_kbdentry_text_XL[kbdentry_canvas][xl] <= motionX < LTsv_kbdentry_text_XL[kbdentry_canvas][xl+1]: break;
            LTsv_kbdentry_text_SEL[kbdentry_canvas]=xl
            if LTsv_kbdentry_cursorL[kbdentry_canvas] <= LTsv_kbdentry_text_SEL[kbdentry_canvas] < LTsv_kbdentry_cursorR[kbdentry_canvas]:
                LTsv_kbdentry_text_LCR[kbdentry_canvas]="Move"
                LTsv_kbdentry_text_WK[kbdentry_canvas]=LTsv_kbdentry_text[kbdentry_canvas][LTsv_kbdentry_cursorL[kbdentry_canvas]:LTsv_kbdentry_cursorR[kbdentry_canvas]+1]
                if clip_c != None: clip_c(LTsv_kbdentry_text_WK[kbdentry_canvas])
                LTsv_kbdentry_text[kbdentry_canvas]=LTsv_kbdentry_text[kbdentry_canvas][:LTsv_kbdentry_cursorL[kbdentry_canvas]]+LTsv_kbdentry_text[kbdentry_canvas][LTsv_kbdentry_cursorR[kbdentry_canvas]+1:]
                LTsv_kbdentry_cursorL[kbdentry_canvas]=LTsv_kbdentry_cursorR[kbdentry_canvas]
            else:
                LTsv_kbdentry_text_LCR[kbdentry_canvas]="Select"
                LTsv_kbdentry_cursorL[kbdentry_canvas],LTsv_kbdentry_cursorR[kbdentry_canvas]=xl,xl
            LTsv_draw_delete()
            LTsv_draw_color(LTsv_kbdentry_fontcolor[kbdentry_canvas])
            LTsv_kbdentry_text_XL[kbdentry_canvas]=LTsv_draw_glyphsentry(draw_t=LTsv_kbdentry_text[kbdentry_canvas],draw_x=LTsv_kbdentry_text_LX[kbdentry_canvas],draw_y=LTsv_kbdentry_y[kbdentry_canvas],draw_cL=LTsv_kbdentry_cursorL[kbdentry_canvas],draw_cR=LTsv_kbdentry_cursorR[kbdentry_canvas],draw_f=LTsv_glyph_kbdH//2,draw_g="漫")
    ...
    def kbdentry_release(window_objvoid=None,window_objptr=None):
        ...
        global LTsv_kbdentry_text_LCR,LTsv_kbdentry_text_XL,LTsv_kbdentry_text_LX,LTsv_kbdentry_text_SEL,LTsv_kbdentry_text_WK
        LTsv_draw_selcanvas(kbdentry_canvas)
        if LTsv_glyph_mouserelease(kbdentry_canvas,LTsv_kbdentry_x[kbdentry_canvas],LTsv_kbdentry_y[kbdentry_canvas]) == LTsv_glyph_None:
            motionX=LTsv_global_canvasmotionX()
            for xl in range(len(LTsv_kbdentry_text_XL[kbdentry_canvas])-1):
                if LTsv_kbdentry_text_XL[kbdentry_canvas][xl] <= motionX < LTsv_kbdentry_text_XL[kbdentry_canvas][xl+1]: break;
            if LTsv_kbdentry_text_LCR[kbdentry_canvas] == "Select":
                if LTsv_kbdentry_text_SEL[kbdentry_canvas] < xl: LTsv_kbdentry_cursorL[kbdentry_canvas],LTsv_kbdentry_cursorR[kbdentry_canvas]=LTsv_kbdentry_text_SEL[kbdentry_canvas],xl
                else: LTsv_kbdentry_cursorL[kbdentry_canvas],LTsv_kbdentry_cursorR[kbdentry_canvas]=xl,LTsv_kbdentry_text_SEL[kbdentry_canvas]
            elif LTsv_kbdentry_text_LCR[kbdentry_canvas] == "Move":
                LTsv_kbdentry_cursorL[kbdentry_canvas],LTsv_kbdentry_cursorR[kbdentry_canvas]=xl,xl
                LTsv_kbdentry_text[kbdentry_canvas]=LTsv_kbdentry_text[kbdentry_canvas][:LTsv_kbdentry_cursorL[kbdentry_canvas]]+LTsv_kbdentry_text_WK[kbdentry_canvas]+LTsv_kbdentry_text[kbdentry_canvas][LTsv_kbdentry_cursorR[kbdentry_canvas]:]
            LTsv_draw_delete()
            LTsv_draw_color(LTsv_kbdentry_fontcolor[kbdentry_canvas])
            LTsv_kbdentry_text_XL[kbdentry_canvas]=LTsv_draw_glyphsentry(draw_t=LTsv_kbdentry_text[kbdentry_canvas],draw_x=LTsv_kbdentry_text_LX[kbdentry_canvas],draw_y=LTsv_kbdentry_y[kbdentry_canvas],draw_cL=LTsv_kbdentry_cursorL[kbdentry_canvas],draw_cR=LTsv_kbdentry_cursorR[kbdentry_canvas],draw_f=LTsv_glyph_kbdH//2,draw_g="漫")
            LTsv_glyph_kbddelete(kbdentry_canvas)
            LTsv_glyph_kbddraw(kbdentry_canvas,LTsv_kbdentry_x[kbdentry_canvas],LTsv_kbdentry_y[kbdentry_canvas])
        LTsv_draw_queue()
        LTsv_kbdentry_text_LCR[kbdentry_canvas]=""
    def kbdentry_motion(window_objvoid=None,window_objptr=None):
        global LTsv_kbdentry_x,LTsv_kbdentry_y,LTsv_kbdentry_text,LTsv_kbdentry_fontcolor,LTsv_kbdentry_cursorL
        global LTsv_kbdentry_text_LCR,LTsv_kbdentry_text_XL,LTsv_kbdentry_text_LX,LTsv_kbdentry_text_SEL,LTsv_kbdentry_text_WK
        LTsv_draw_selcanvas(kbdentry_canvas)
        if LTsv_glyph_mousemotion(kbdentry_canvas,LTsv_kbdentry_x[kbdentry_canvas],LTsv_kbdentry_y[kbdentry_canvas]) == LTsv_glyph_None:
            if len(LTsv_kbdentry_text_LCR[kbdentry_canvas]):
                motionX=LTsv_global_canvasmotionX()
                for xl in range(len(LTsv_kbdentry_text_XL[kbdentry_canvas])-1):
                    if LTsv_kbdentry_text_XL[kbdentry_canvas][xl] <= motionX < LTsv_kbdentry_text_XL[kbdentry_canvas][xl+1]: break;
            if LTsv_kbdentry_text_LCR[kbdentry_canvas] == "Select":
                ...
                LTsv_draw_color(LTsv_kbdentry_fontcolor[kbdentry_canvas])
                LTsv_kbdentry_text_XL[kbdentry_canvas]=LTsv_draw_glyphsentry(draw_t=LTsv_kbdentry_text[kbdentry_canvas],draw_x=LTsv_kbdentry_text_LX[kbdentry_canvas],draw_y=LTsv_kbdentry_y[kbdentry_canvas],draw_cL=LTsv_kbdentry_cursorL[kbdentry_canvas],draw_cR=LTsv_kbdentry_cursorR[kbdentry_canvas],draw_f=LTsv_glyph_kbdH//2,draw_g="漫")
                LTsv_draw_glyphs(draw_t=LTsv_kbdentry_text_WK[kbdentry_canvas],draw_x=motionX,draw_y=LTsv_kbdentry_y[kbdentry_canvas]+LTsv_glyph_kbdH//2,draw_f=LTsv_glyph_kbdH//2,draw_g="漫")
                LTsv_glyph_kbddelete(kbdentry_canvas)
                LTsv_glyph_kbddraw(kbdentry_canvas,LTsv_kbdentry_x[kbdentry_canvas],LTsv_kbdentry_y[kbdentry_canvas])
        LTsv_draw_queue()
    ...
    def kbdentry_leave(window_objvoid=None,window_objptr=None):
        ...
        global LTsv_kbdentry_text_LCR,LTsv_kbdentry_text_XL,LTsv_kbdentry_text_LX,LTsv_kbdentry_text_SEL,LTsv_kbdentry_text_WK
        LTsv_kbdentry_text_LCR[kbdentry_canvas]=""; LTsv_kbdentry_text_WK[kbdentry_canvas]=""
        ...
        LTsv_draw_selcanvas(kbdentry_canvas)
        LTsv_draw_delete()
        LTsv_draw_color(LTsv_kbdentry_fontcolor[kbdentry_canvas]); LTsv_draw_glyphsfill(draw_t=LTsv_kbdentry_text[kbdentry_canvas],draw_x=0,draw_y=LTsv_kbdentry_y[kbdentry_canvas],draw_f=LTsv_glyph_kbdH//2,draw_g="漫")
        LTsv_draw_queue()
    ...
    LTsv_kbdentry_text_LX[kbdentry_canvas]=0; LTsv_kbdentry_text_LCR[kbdentry_canvas]=""
    LTsv_kbdentry_text_WK[kbdentry_canvas]=""
...
#    LTsv_widget_getobj(LTsv_widgetPAGE,"kbdentry_leave")()
    ...
    LTsv_draw_selcanvas(kbdentry_canvas)
    LTsv_draw_delete()
    LTsv_draw_color(LTsv_kbdentry_fontcolor[kbdentry_canvas]); LTsv_draw_glyphsfill(draw_t=LTsv_kbdentry_text[kbdentry_canvas],draw_x=LTsv_kbdentry_text_LX[kbdentry_canvas],draw_y=LTsv_kbdentry_y[kbdentry_canvas],draw_f=LTsv_glyph_kbdH//2,draw_g="漫")
    LTsv_draw_queue()
...
LTsv_editcanvasUX,LTsv_editcanvasUY,LTsv_editcanvasUT,LTsv_editcanvasUF,LTsv_editcanvasUB,LTsv_editcanvasUL,LTsv_editcanvasUR,LTsv_editcanvasUP,LTsv_editcanvasUK,LTsv_editcanvasUQ={},{},{},{},{},{},{},{},{},{}
LTsv_editcanvasTX,LTsv_editcanvasTY,LTsv_editcanvasTT,LTsv_editcanvasTF,LTsv_editcanvasTB,LTsv_editcanvasTL,LTsv_editcanvasTR,LTsv_editcanvasTP,LTsv_editcanvasTK,LTsv_editcanvasTQ={},{},{},{},{},{},{},{},{},{}
LTsv_editcanvasKX,LTsv_editcanvasKY={},{}
def LTsv_editcanvas_new(LTsv_windowPAGENAME,widget_n=None,event_b=None,clip_c=None,clip_v=None,clip_k=None,widget_x=0,widget_y=0,widget_w=LTsv_glyph_kbdW,widget_h=LTsv_glyph_kbdH,event_w=50):
#gettext,geturi
    global LTsv_editcanvasUT,LTsv_editcanvasUX,LTsv_editcanvasUY,LTsv_editcanvasUF,LTsv_editcanvasUB,LTsv_editcanvasUL,LTsv_editcanvasUR,LTsv_editcanvasUP,LTsv_editcanvasUK,LTsv_editcanvasUQ
    global LTsv_editcanvasTT,LTsv_editcanvasTX,LTsv_editcanvasTY,LTsv_editcanvasTF,LTsv_editcanvasTB,LTsv_editcanvasTL,LTsv_editcanvasTR,LTsv_editcanvasTP,LTsv_editcanvasTK,LTsv_editcanvasTQ
    global LTsv_editcanvasKX,LTsv_editcanvasKY
    def editcanvas_input(UC):
        ...
        if UC in "":
            ...
            if UC in "":
                if clip_k != None:
                    LTsv_editcanvasUT[editcanvas]=clip_k(LTsv_editcanvasUT[editcanvas])
        else:
        ...
        editcanvas_settext(editcanvas)
    def editcanvas_settext(editcanvas,UT=None,UL=None,UR=None):
        global LTsv_editcanvasUT,LTsv_editcanvasUX,LTsv_editcanvasUY,LTsv_editcanvasUF,LTsv_editcanvasUB,LTsv_editcanvasUL,LTsv_editcanvasUR,LTsv_editcanvasUP,LTsv_editcanvasUK,LTsv_editcanvasUQ
        global LTsv_editcanvasTT,LTsv_editcanvasTX,LTsv_editcanvasTY,LTsv_editcanvasTF,LTsv_editcanvasTB,LTsv_editcanvasTL,LTsv_editcanvasTR,LTsv_editcanvasTP,LTsv_editcanvasTK,LTsv_editcanvasTQ
        LTsv_editcanvasUT[editcanvas]=LTsv_editcanvasUT[editcanvas] if UT == None else UT
        ...
        LTsv_editcanvasUP[editcanvas]=LTsv_draw_glyphsentry(draw_t=LTsv_editcanvasUT[editcanvas],draw_x=LTsv_editcanvasUX[editcanvas],draw_y=LTsv_editcanvasUY[editcanvas],draw_cL=LTsv_editcanvasUL[editcanvas],draw_cR=LTsv_editcanvasUR[editcanvas],draw_f=LTsv_glyph_kbdH//2,draw_g="漫")
        LTsv_draw_glyphs(draw_t=LTsv_editcanvasUK[editcanvas],draw_x=LTsv_global_canvasmotionX(),draw_y=LTsv_global_canvasmotionY(),draw_f=LTsv_glyph_kbdH//2,draw_g="漫")
        LTsv_glyph_kbddelete(editcanvas)
        LTsv_glyph_kbddraw(editcanvas,LTsv_editcanvasKX[editcanvas],LTsv_editcanvasKY[editcanvas])
        LTsv_draw_queue()
    def editcanvas_deftext(editcanvas,UT=None):
        global LTsv_editcanvasUT,LTsv_editcanvasUX,LTsv_editcanvasUY,LTsv_editcanvasUF,LTsv_editcanvasUB,LTsv_editcanvasUL,LTsv_editcanvasUR,LTsv_editcanvasUP,LTsv_editcanvasUK,LTsv_editcanvasUQ
        global LTsv_editcanvasTT,LTsv_editcanvasTX,LTsv_editcanvasTY,LTsv_editcanvasTF,LTsv_editcanvasTB,LTsv_editcanvasTL,LTsv_editcanvasTR,LTsv_editcanvasTP,LTsv_editcanvasTK,LTsv_editcanvasTQ
        LTsv_editcanvasUT[editcanvas]=LTsv_editcanvasUT[editcanvas] if UT == None else UT
        ...
        LTsv_draw_selcanvas(editcanvas); LTsv_draw_delete();
        LTsv_draw_color(LTsv_editcanvasUF[editcanvas])
        LTsv_draw_glyphsfill(draw_t=LTsv_editcanvasUT[editcanvas],draw_x=LTsv_editcanvasUX[editcanvas],draw_y=LTsv_editcanvasUY[editcanvas],draw_f=LTsv_glyph_kbdH//2,draw_g="漫")
        LTsv_draw_queue()
...
#            LTsv_editcanvasKX[editcanvas]=0 if LTsv_global_canvasmotionX() > widget_w//2 else widget_w-LTsv_glyph_kbdW
            editcanvas_settext(editcanvas)
    ...
    def editcanvas_leave(window_objvoid=None,window_objptr=None):
        if LTsv_editcanvasUQ[editcanvas] != None: LTsv_editcanvasUQ[editcanvas](LTsv_editcanvasUT[editcanvas])
        editcanvas_deftext(editcanvas)
    def editcanvas_gettext():
        return LTsv_editcanvasTT[editcanvas]
    def editcanvas_geturi():
    ...
    LTsv_editcanvasUX[editcanvas],LTsv_editcanvasUY[editcanvas],LTsv_editcanvasUT[editcanvas],LTsv_editcanvasUF[editcanvas],LTsv_editcanvasUB[editcanvas],LTsv_editcanvasUL[editcanvas],LTsv_editcanvasUR[editcanvas],LTsv_editcanvasUP[editcanvas],LTsv_editcanvasUK[editcanvas],LTsv_editcanvasUQ[editcanvas]=0,widget_h-LTsv_glyph_kbdH//2,"","black","white",0,0,[0],"",event_b
#    LTsv_editcanvasTX[editcanvas],LTsv_editcanvasTY[editcanvas],LTsv_editcanvasTT[editcanvas],LTsv_editcanvasTF[editcanvas],LTsv_editcanvasTB[editcanvas],LTsv_editcanvasTL[editcanvas],LTsv_editcanvasTR[editcanvas],LTsv_editcanvasTP[editcanvas],LTsv_editcanvasTK[editcanvas],LTsv_editcanvasTQ[editcanvas]={},{},{},{},{},{},{},{},{},{}
    LTsv_editcanvasKX[editcanvas],LTsv_editcanvasKY[editcanvas]=widget_w-LTsv_glyph_kbdW,widget_h-LTsv_glyph_kbdH
    ...
    LTsv_widgetPAGE=LTsv_widgetPAGEXYWH(LTsv_widgetPAGE,widget_k="editcanvas", \
     ...
     kbd_i=editcanvas_input,kbd_s=editcanvas_settext,kbd_c=clip_c,kbd_v=clip_v,kbd_k=clip_k,kbd_t=editcanvas_gettext,kbd_u=editcanvas_geturi,kbd_d=editcanvas_deftext)
