...
if len(LTsv_GUI) > 0:
    ...
    for map_xy in range(len(LTsv_global_irohaalpha())):
        ...
        if map_xy < len(LTsv_global_irohaalpha())-4: continue;
        LTsv_glyph_kbdXX[map_xy],LTsv_glyph_kbdXY[map_xy]=LTsv_glyph_kbdXX[map_xy]+LTsv_glyph_kbdW*9,LTsv_glyph_kbdXY[map_xy]-kanmap_kbdNH*7
