...
if len(LTsv_GUI) > 0:
    ...
    kanfont_dic_button=LTsv_button_new(kanfont_window,widget_t=kanfont_dicname,widget_x=kanfont_savebutton_X+kanfont_entry_W//2*0,widget_y=kanfont_H-kanfont_label_WH*2,widget_w=kanfont_entry_W//2,widget_h=kanfont_label_WH,widget_f=kanfont_font_entry,event_b=None)
    kanfont_map_button=LTsv_button_new(kanfont_window,widget_t=kanfont_mapname,widget_x=kanfont_savebutton_X+kanfont_entry_W//2*1,widget_y=kanfont_H-kanfont_label_WH*2,widget_w=kanfont_entry_W//2,widget_h=kanfont_label_WH,widget_f=kanfont_font_entry,event_b=None)
    kanfont_svg5x5_button=LTsv_button_new(kanfont_window,widget_t=kanfont_svgname,widget_x=kanfont_savebutton_X+kanfont_entry_W//2*0,widget_y=kanfont_H-kanfont_label_WH*1,widget_w=kanfont_entry_W//2,widget_h=kanfont_label_WH,widget_f=kanfont_font_entry,event_b=None)
    kanfont_svgcomic_button=LTsv_button_new(kanfont_window,widget_t=kanfont_svgname,widget_x=kanfont_savebutton_X+kanfont_entry_W//2*1,widget_y=kanfont_H-kanfont_label_WH*1,widget_w=kanfont_entry_W//2,widget_h=kanfont_label_WH,widget_f=kanfont_font_entry,event_b=None)
